...
var dbDialect = flag.String("db-dialect", "sqlite", "Database dialect (sqlite3 or postgres)")
var dbAddress = flag.String("db-address", "file:wa_example.db?_pragma=foreign_keys(1)", "Database address")
